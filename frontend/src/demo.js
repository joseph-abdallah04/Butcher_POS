...
const handlers = {
  ...
  'GET /reports/top-products': (_, __, query) => {
    const m = demoReportMultiplier(query);
    const rows = [
      { product_id: 61, product_name: 'Eye Fillet Steak', category: 'Beef', units_sold: 412, net_revenue: 24685, net_profit: 13280 },
      { product_id: 64, product_name: 'Lamb Chops', category: 'Lamb', units_sold: 528, net_revenue: 14784, net_profit: 6182 },
      { product_id: 63, product_name: 'Ribeye Steak', category: 'Beef', units_sold: 285, net_revenue: 14107, net_profit: 5278 },
      { product_id: 67, product_name: 'Chicken Breast', category: 'Poultry', units_sold: 720, net_revenue: 12960, net_profit: 5760 },
      { product_id: 72, product_name: 'Lamb Cutlets', category: 'Lamb', units_sold: 198, net_revenue: 7524, net_profit: 3168 },
      { product_id: 68, product_name: 'Pork Belly', category: 'Pork', units_sold: 290, net_revenue: 6960, net_profit: 2900 },
      { product_id: 62, product_name: 'Beef Mince', category: 'Beef', units_sold: 920, net_revenue: 15180, net_profit: 6900 },
      { product_id: 70, product_name: 'Bacon Rashers', category: 'Smallgoods', units_sold: 380, net_revenue: 6080, net_profit: 3040 },
      { product_id: 69, product_name: 'Italian Sausages', category: 'Smallgoods', units_sold: 480, net_revenue: 6720, net_profit: 3360 },
      { product_id: 66, product_name: 'Whole Chicken', category: 'Poultry', units_sold: 220, net_revenue: 2750, net_profit: 1210 },
    ];
    return rows.map((r) => ({
      ...r,
  ...
  'GET /reports/wastage-summary': (_, __, query) => {
    ...
    return {
      ...
      by_product: [
        { product_id: 64, product_name: 'Lamb Chops', category: 'Lamb', total_loss_value: 980.5 * m, quantity_wasted: 35.0 * m, events: Math.round(12 * m) },
        { product_id: 67, product_name: 'Chicken Breast', category: 'Poultry', total_loss_value: 720.0 * m, quantity_wasted: 40.0 * m, events: Math.round(14 * m) },
        { product_id: 62, product_name: 'Beef Mince', category: 'Beef', total_loss_value: 540.0 * m, quantity_wasted: 60.0 * m, events: Math.round(18 * m) },
        { product_id: 70, product_name: 'Bacon Rashers', category: 'Smallgoods', total_loss_value: 320.0 * m, quantity_wasted: 20.0 * m, events: Math.round(8 * m) },
        { product_id: 66, product_name: 'Whole Chicken', category: 'Poultry', total_loss_value: 245.0 * m, quantity_wasted: 35.0 * m, events: Math.round(7 * m) },
      ],
    };
  },
